...
I18n.translations.nl = {
    ...
    license_info_panel: {
        ...
        has_license_sp_html: "Een licentie voor <a href=\"{{serviceUrl}}\" target=\"_blank\" rel=\"noopener noreferrer\">{{serviceName}}</a> kan via de aanbieder van deze dienst {{organisation}} worden afgesloten.",
        has_license_sp_html_no_service_url: "Een licentie voor {{serviceName}}</a> kan via de aanbieder van deze dienst {{organisation}} worden afgesloten.",
    ...
    overview_panel: {
        ...
        aansluitovereenkomstRefused: "{{organisation}} heeft geweigerd om de 'SURFconext aansluitovereenkomst' te tekenen. Lees meer over deze overeenkomst op de <a href=\"https://support.surfconext.nl/dashboard-info-trust\" target=\"_blank\" rel=\"noopener noreferrer\">SURF wiki</a>.",
    ...
    privacy_panel: {
        ...
        certificationLocation: "Waar is informatie over informatiebeveiliging-certificering te vinden?",
        ...
        surfmarketDpaAgreement: "Biedt leverancier een DPA aan in het SURF licentieportaal?",
    ...
    how_to_connect_panel: {
        ...
        read: "Lees de",
        single_tenant_service_warning: "Verzoeken voor activatie van single tenant diensten duren langer om te verwerken. SURF zal contact opnemen zodra het dit verzoek heeft ontvangen.",
    ...
    footer: {
        surfnet_html: "<a href=\"https://www.surfnet.nl/\" target=\"_blank\" rel=\"noopener noreferrer\">SURF</a>",
    ...
    my_idp: {
        ...
        guest_enabled_tooltip: "Als gast toegang is ingeschakeld betekent dat gebruikers<br>van de gast IdPgebruik kunnen maken van deze dienst.<br>Zie de <a href=\"https://edu.nl/3nu37\" target=\"_blank\" rel=\"noopener noreferrer\">wiki</a> voor meer informatie.",
