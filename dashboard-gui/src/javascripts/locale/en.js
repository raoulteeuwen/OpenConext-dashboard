...
I18n.translations.en = {
    ...
    license_info_panel: {
        ...
        has_license_sp_html: "A license for <a href=\"{{serviceUrl}}\" target=\"_blank\" rel=\"noopener noreferrer\">{{serviceName}}</a> can be acquired from {{organisation}} who is the the supplier of this service.",
        has_license_sp_html_no_service_url: "A license for {{serviceName}} can be acquired from {{organisation}} who is the supplier of this service.",
    ...
    overview_panel: {
        ...
        aansluitovereenkomstRefused: "{{organisation}} has refused to sign the 'SURFconext connection agreement' with SURF. Read more about this policy on the <a href=\"https://support.surfconext.nl/dashboard-info-trust\" target=\"_blank\" rel=\"noopener noreferrer\">SURF wiki</a>.",
