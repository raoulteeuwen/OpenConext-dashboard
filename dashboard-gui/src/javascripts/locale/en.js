...
I18n.translations.en = {
    ...
    how_to_connect_panel: {
        ...
        info_connection_without_interaction: "This service provider allows institutions to connect immediately. There is no need to wait for an connection request to be processed, you can use the service right away.",
